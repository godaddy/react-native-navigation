...
public abstract class Screen extends RelativeLayout implements Subscriber {
    ...
    public void show(boolean animated, Bundle nextScreenAnimation) {
        show(animated, nextScreenAnimation, null);
    }
    ...
    public void show(boolean animated, Bundle nextScreenAnimation, Runnable onAnimationEnd) {
        ...
        setStyle();
        screenAnimator.show(animated, nextScreenAnimation, onAnimationEnd);
    }
