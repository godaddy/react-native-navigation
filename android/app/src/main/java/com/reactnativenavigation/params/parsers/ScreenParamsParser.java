...
public class ScreenParamsParser extends Parser {
    ...
    private static final String SHOW_SCREEN_ANIMATION = "androidShowScreenAnimation";
    private static final String HIDE_SCREEN_ANIMATION = "androidHideScreenAnimation";
